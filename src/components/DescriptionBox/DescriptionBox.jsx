...
const DescriptionBox = () => {
  return (
    <div className="descriptionBox my-20 mx-20">
      <div className="navigator flex">
        <div className="nav-box flex items-center justify-center text-[20px] font-semibold w-[170px] h-[70px] border-1 border-solid border-[#d0d0d0]">
          Description
        </div>
        <div className="nav-box fade bg-[#fbfbfb] text-[#555] flex items-center justify-center text-[20px] w-[170px] border-1 border-solid border-[#d0d0d0]">
          Reviews (122)
        </div>
      </div>
